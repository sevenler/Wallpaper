...
public class ClassActivity extends ReflushBaseActivity {
	...
	protected void refreshToLoad() {
		new ImgListUpdateFromTagTask(mTag, DISPLAY_SIZE, skip, mLimitEachPage).setOnProgressListenner(new OnProgressListenner() {
			...
			public void onFinish(Object... result) {
				...
				LOG.i(ClassActivity.this, String.format(MESSAGE_GETED_IMAGES, imgs.size(), imgs.toString()));
	...
	private class ClassAdapter extends BaseAdapter {
		...
		private int mItemWidth = DISPLAY_SIZE.getWidth() / GRID_COLUME_NUMBER - (int)Utils.Densitys.dip2px(ClassActivity.this, 5);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			LOG.i(ClassActivity.this, String.format(MESSAGE_LOAD_IMAGE, url, img.getWidth(), img.getHeight()));
			imageLoader.displayImage(url, image, options, new SimpleImageLoadingListener() {
				@Override
				public void onLoadingComplete(Bitmap loadedImage) {
					Animation anim = AnimationUtils.loadAnimation(ClassActivity.this, R.anim.fade_in);
